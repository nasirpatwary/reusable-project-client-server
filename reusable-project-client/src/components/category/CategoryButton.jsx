  ...
  return (
    <>
      ...
      >
        ...
        <CiCirclePlus className="w-16 h-16 mx-auto opacity-0 group-hover:opacity-100 transition-all duration-700 rounded-full absolute right-0 group-hover:bottom-7 bottom-0 left-0"  />
